...
def main(page: ft.Page):
    ...
    def clear(): 
        nonlocal current_number, current_calculation, calculation_back, result, calculation_show
    ...
    def back(): 
        nonlocal current_number, current_calculation, calculation_back, result, calculation_show, calc_state, brackets_type
        result.value=""
        calc_state=True
        if current_calculation != []:
            if current_number != []:
